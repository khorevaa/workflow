...
Функция Скопировать() Экспорт
	...
	Для каждого КлючЗначение Из ИндексОбработчиков Цикл
		
		НовыйОбработчикиСобытий.Добавить(КлючЗначение.Ключ, РаботаСТипами.Скопировать(КлючЗначение.Значение, , Ложь));
